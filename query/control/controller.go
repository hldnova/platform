...
type Controller struct {
	...
	// TODO(jsternberg): Figure out an abstraction for how the Controller makes decisions so we can
	// have different strategies similar to how an OS scheduler may be constructed. It would be good
	// to build this in as we can then try different methods of scheduling.
}
