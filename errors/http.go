...
// HandleHTTPErr sets the X-Influx-Error and X-Influx-Reference headers on the response,
func HandleHTTPErr(ctx context.Context, e HTTPError, w http.ResponseWriter) {
	if e == nil {
		return
	}
